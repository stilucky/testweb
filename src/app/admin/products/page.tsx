                  ...
                  <div className="col-span-2 min-w-0">
                    {productCollections.length > 0 ? (
                      <div
                        ...
                        title={productCollections.map((collection) => collection.name).join(", ")}
                      >
                        {productCollections.map((collection) => (
                          <span
                            key={collection.id}
                            className="max-w-full truncate bg-stone-100 px-1.5 py-0.5 text-[10px] uppercase tracking-wider text-stone-600"
                          >
                            {collection.name}
                          </span>
                        ))}
