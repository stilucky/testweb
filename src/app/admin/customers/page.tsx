...
export default function CustomersPage() {
  ...
  const SortIcon = ({ k }: { k: SortKey }) =>
    sortKey === k
      ? sortAsc
        ? <ChevronUp size={12} className="text-stone-900" />
        : <ChevronDown size={12} className="text-stone-900" />
    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          { label: "Total Revenue", value: totalRevenue > 0 ? formatPrice(totalRevenue) : "$0", sub: "lifetime" },
        ].map(({ label, value, sub }) => (
      ...
      <div className="bg-white border border-stone-100">
        {customers.length === 0 ? (
          <div className="py-20 text-center">
            ...
            <p className="text-stone-300 text-xs mt-1">Registered users will appear here</p>
          </div>
        ) : (
          <>
                ...
                <thead>
                  <tr className="border-b border-stone-100">
                    <th className="text-left px-6 py-3">
                      <button onClick={() => toggleSort("name")} className="flex items-center gap-1 text-[10px] tracking-widest uppercase text-stone-400 font-normal hover:text-stone-700">
                    ...
                    <th className="text-left px-6 py-3">
                      <button onClick={() => toggleSort("joined")} className="flex items-center gap-1 text-[10px] tracking-widest uppercase text-stone-400 font-normal hover:text-stone-700">
                              ...
                              <div className="flex flex-wrap gap-8 text-sm">
                                ...
                                <div>
                                  ...
                                  <p className="text-stone-700">
                                    {c.orders > 0 ? formatPrice(c.totalSpent / c.orders) : "—"}
                                  </p>
                                </div>
                                <div>
